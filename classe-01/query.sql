...
SELECT composicao, tempo FROM musicas WHERE tempo / 60.0 > 4;
...
SELECT * FROM musicas WHERE tempo / 60.0 < 5 AND compositor IS NOT NULL AND compositor != 'Bach';
...
SELECT * FROM musicas ORDER BY tempo ASC LIMIT 10;
